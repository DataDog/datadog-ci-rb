...
module Datadog
  module CI
    module Remote
      ...
      class Component
        def initialize(library_settings_api:)
          @library_settings_api = library_settings_api
        end
        ...
        def configure(test_session)
          library_configuration = @library_settings_api.fetch_library_settings(test_session)
