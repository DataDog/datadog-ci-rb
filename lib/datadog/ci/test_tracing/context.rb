  ...
  module CI
    module TestTracing
      ...
      class Context
        ...
        def initialize(test_tracing_component:, runtime_tags: {})
        ...
        def set_initial_tags(ci_span, tags)
          ...
          ci_span.set_tags(@runtime_tags) unless @runtime_tags.empty?
        ...
        def set_session_context(tags, test_session = nil)
          # we need to call TestTracing::Component here because active test session might be remote
        ...
        def set_module_context(tags, test_module = nil)
          # we need to call TestTracing::Component here because active test module might be remote
        ...
        def test_session_context
          ...
          remote_test_session = @test_tracing_component.active_test_session
        ...
        def test_module_context
          ...
          remote_test_module = @test_tracing_component.active_test_module
