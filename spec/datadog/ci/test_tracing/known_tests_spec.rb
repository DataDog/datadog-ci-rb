...
require_relative "../../../../lib/datadog/ci/test_tracing/known_tests"

RSpec.describe Datadog::CI::TestTracing::KnownTests do
  ...
  describe Datadog::CI::TestTracing::KnownTests::Response do
