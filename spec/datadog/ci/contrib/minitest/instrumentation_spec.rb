    ...
    context "run minitest suite" do
      ...
      context "passed tests" do
        ...
        it "creates code coverage events" do
          ...
          expect(cov_event.coverage.keys).to include(absolute_path("helpers/constants.rb")) if Datadog::CI::SourceCode::StaticDependencies::STATIC_DEPENDENCIES_AVAILABLE
