RSpec.describe Datadog::CI::Span do
  ...
  describe "#set_environment_runtime_tags" do
    ...
    it "sets the environment runtime tags" do
      expect(tracer_span).to receive(:set_tags).with({
        "os.architecture" => ::RbConfig::CONFIG["host_cpu"],
        "os.platform" => ::RbConfig::CONFIG["host_os"],
        "os.version" => Datadog::CI::Span::ENVIRONMENT_RUNTIME_TAGS["os.version"],
        "runtime.name" => Datadog::Core::Environment::Ext::LANG_ENGINE,
        "runtime.version" => Datadog::Core::Environment::Ext::ENGINE_VERSION
      })
