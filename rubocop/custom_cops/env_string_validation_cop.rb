...
require_relative "../../lib/datadog/ci/configuration/supported_configurations"
require "datadog/core/configuration/supported_configurations"
...
module CustomCops
  ...
  class EnvStringValidationCop < RuboCop::Cop::Base
    ...
    ALLOWED_ENV_VARS = Datadog::CI::Configuration::SUPPORTED_CONFIGURATION_NAMES +
      Datadog::Core::Configuration::SUPPORTED_CONFIGURATION_NAMES

    def on_str(node)
      # Environment variable format: starts with DD_ or OTEL_
      # Must contain only letters, numbers, and underscores
      return unless node.value.scrub.match?(/^(DD_|OTEL_)[A-Z][A-Z0-9_]*$/)
